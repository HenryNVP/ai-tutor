...
class SessionEvent(BaseModel):
    type: Literal["message", "upload", "quiz", "note", "quiz_submission", "visualization"]
    ...
    csv_filename: Optional[str] = Field(default=None, description="CSV filename for visualization")
