...
def build_note_agent(
    ...
    instructions = (
        ...
        "2. Call retrieve_local_context ONCE with top_k=10 (increase if the learner wants very detailed notes) using a concise question such as \"What does <document name> cover?\".\n"
        "3. Merge all retrieved passages into structured notes (clear headings, bullet lists, key takeaways). Include the learner's requested focus areas.\n"
