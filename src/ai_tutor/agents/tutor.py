    ...
    def _build_agents(self) -> None:
        ...
        self.orchestrator_agent = Agent(
            ...
            instructions=(
                ...
                "- ⚠️ DO NOT use Chroma MCP tools (query_with_text, query_collection) for retrieval.\n"
                "  * These tools require knowing collection names, which you don't know.\n"
                "  * Instead, route STEM questions to qa_agent which uses retrieve_local_context.\n"
                "  * retrieve_local_context automatically searches ALL collections.\n"
